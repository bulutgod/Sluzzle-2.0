...
public class TitleAnimator : MonoBehaviour
{
    ...
    {
        new Color(1f, 0.35f, 0.5f),     // Pembe-K�rm�z�
        new Color(1f, 0.6f, 0.2f),      // Turuncu
        new Color(1f, 0.9f, 0.3f),      // Sar�
        new Color(0.4f, 0.9f, 0.5f),    // Ye�il
    ...
    private void SetupTitle()
    {
        ...
        // Glow efekti i�in material ayar�
        if (enableGlow && titleText.fontMaterial != null)
        {
            // Glow i�in material instance olu�tur
    ...
    private void GlowAnimation()
    {
        if (textMaterial != null)
        {
            ...
            // TMP'nin glow �zelliklerini kullan
    ...
    private void AnimateGradient()
    {
        ...
        // Renkleri d�ng�sel olarak de�i�tir
    ...
    private void WaveAnimation()
    {
        ...
        for (int i = 0; i < textInfo.characterCount; i++)
        {
            ...
            // Her harf i�in wave offset hesapla
    ...
    // Entrance animasyonu (sahne a��l���nda �a��r)
    ...
    {
        // Ba�lang��ta g�r�nmez ve yukar�da
        titleText.alpha = 0f;
