...
public class ModernTileVisuals : MonoBehaviour
{
    ...
    [SerializeField] private float cornerRadius = 0.2f; // Daha yumu�ak k��eler
    ...
    {
        // Foto�raftaki gibi yumu�ak k��eli square sprite
        ...
        for (int y = 0; y < 256; y++)
        {
            for (int x = 0; x < 256; x++)
            {
                ...
                bool isInside = IsInsideRoundedSquare(pos, center, 120, radius); // 120 = biraz daha k���k
